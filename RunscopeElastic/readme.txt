...
To configure Runscope to monitor an Elasticsearch cluster and post the monitoring result into the
cluster:
...
* Add a variable with source "JSON Body", no property, and variable name "result".
